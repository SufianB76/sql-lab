...
SELECT * FROM countrylanguage WHERE language = 'Italian' AND countrylanguage.isofficial = 't';
SELECT * FROM country WHERE code IN ('ITA','SMR','VAT','CHE');
...
SELECT * FROM city WHERE population > 91000 ORDER BY population ASC;
